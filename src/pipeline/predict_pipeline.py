...
class PredictionPipelineConfig:
    ...
    preprocessor_path : str = os.path.join(artifact_folder,'model.pkl')
...
class PredictionPipeline:
    ...
    def get_predicted_dataframe(self,input_dataframe_path: pd.DataFrame):
        try:
            ...
            inuput_dataframe  = input_dataframe.drop(columns="Unnamed : 0") if "Unnamed : 0" in input_dataframe.columns else input_dataframe
